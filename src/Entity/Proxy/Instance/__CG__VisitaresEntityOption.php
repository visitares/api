 ...
 */
class Option extends \Visitares\Entity\Option implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'input', 'coefficient', 'sort', 'labelTranslation');
        }
