 ...
 */
class Catalog extends \Visitares\Entity\Catalog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'attributes', 'entries', 'nameTranslation', 'descriptionTranslation');
        }
