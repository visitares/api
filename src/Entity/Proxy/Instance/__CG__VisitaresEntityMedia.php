 ...
 */
class Media extends \Visitares\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'masterId', 'instanceToken', 'group', 'language', 'label', 'description', 'type', 'mime', 'filename', 'originalFilename', 'ext', 'filesize', 'length');
        }
