 ...
 */
class Value extends \Visitares\Entity\Value implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'submit', 'input', 'option', 'checked', 'text', 'coefficient');
        }
