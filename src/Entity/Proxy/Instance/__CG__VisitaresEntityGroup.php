...
class Group extends \Visitares\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'creationDate', 'modificationDate', 'categories', 'users', 'isDefault', 'isDefaultConfig', 'defaultAppScreen', 'nameTranslation', 'descriptionTranslation'];
        }
