 ...
 */
class Group extends \Visitares\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'categories', 'users', 'isDefault', 'isDefaultConfig', 'defaultAppScreen', 'nameTranslation', 'descriptionTranslation');
        }
     ...
     * {@inheritDoc}
     */
    public function addCategory(\Visitares\Entity\Category $category)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCategory(\Visitares\Entity\Category $category)
    {
     ...
     * {@inheritDoc}
     */
    public function addUser(\Visitares\Entity\User $user)
    {
     ...
     * {@inheritDoc}
     */
    public function removeUser(\Visitares\Entity\User $user)
    {
