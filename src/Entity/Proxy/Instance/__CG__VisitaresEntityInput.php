 ...
 */
class Input extends \Visitares\Entity\Input implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'form', 'options', 'coefficient', 'unit', 'sort', 'required', 'labelTranslation');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Input $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addOption(\Visitares\Entity\Option $option)
    {
     ...
     * {@inheritDoc}
     */
    public function removeOption(\Visitares\Entity\Option $option)
    {
    ...
    public function setLabel($langCode, $value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLabel', array($langCode, $value));

        return parent::setLabel($langCode, $value);
    }
    ...
    public function getLabel($langCode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLabel', array($langCode));

        return parent::getLabel($langCode);
    }
