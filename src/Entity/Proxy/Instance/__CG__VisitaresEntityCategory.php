...
class Category extends \Visitares\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'creationDate', 'modificationDate', 'client', 'groups', 'isActive', 'isCopy', 'beginDate', 'endDate', 'inputLockHours', 'sort', 'lineBreak', 'dividingLine', 'maxScore', 'processesEnabled', 'enableProcessDefinitions', 'icon', 'iconId', 'nameTranslation', 'descriptionTranslation'];
        }
