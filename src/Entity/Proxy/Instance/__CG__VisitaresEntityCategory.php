 ...
 */
class Category extends \Visitares\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'client', 'groups', 'isActive', 'isCopy', 'beginDate', 'endDate', 'inputLockHours', 'sort', 'lineBreak', 'maxScore', 'processesEnabled', 'enableProcessDefinitions', 'icon', 'iconId', 'nameTranslation', 'descriptionTranslation');
        }
     ...
     * {@inheritDoc}
     */
    public function addGroup(\Visitares\Entity\Group $group)
    {
     ...
     * {@inheritDoc}
     */
    public function removeGroup(\Visitares\Entity\Group $group)
    {
