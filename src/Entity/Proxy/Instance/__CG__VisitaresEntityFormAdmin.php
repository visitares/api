 ...
 */
class FormAdmin extends \Visitares\Entity\FormAdmin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'user', 'form', 'role');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormAdmin $proxy) {
