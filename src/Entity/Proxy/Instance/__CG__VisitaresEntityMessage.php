 ...
 */
class Message extends \Visitares\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'user', 'submit', 'attachments', 'published', 'message');
        }
