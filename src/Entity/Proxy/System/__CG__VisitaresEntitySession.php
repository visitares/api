 ...
 */
class Session extends \Visitares\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'lastAccess', 'token', 'data');
        }
