 ...
 */
class Request extends \Visitares\Entity\Request implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'resource', 'userAgent', 'headers');
        }
