 ...
 */
class Timeline extends \Visitares\Entity\Timeline implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'isActive', 'name', 'shortDescription');
        }
