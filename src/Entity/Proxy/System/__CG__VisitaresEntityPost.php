 ...
 */
class Post extends \Visitares\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'timeline', 'user', 'published', 'title', 'content', 'likes');
        }
