 ...
 */
class MasterMetaGroup extends \Visitares\Entity\MasterMetaGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'master', 'metaGroup');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MasterMetaGroup $proxy) {
