 ...
 */
class Master extends \Visitares\Entity\Master implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'isActive', 'name', 'shortDescription', 'description');
        }
