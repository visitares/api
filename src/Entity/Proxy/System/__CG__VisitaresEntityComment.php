 ...
 */
class Comment extends \Visitares\Entity\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'post', 'user', 'content');
        }
