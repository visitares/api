 ...
 */
class MetaGroup extends \Visitares\Entity\MetaGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'creationDate', 'modificationDate', 'name', 'description');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MetaGroup $proxy) {
